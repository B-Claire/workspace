...
public class Fenetre extends JFrame{
	...
	private void go(){
		nom = (String)JOptionPane.showInputDialog( null, "Entrez votre nom :", "Dialog", JOptionPane.PLAIN_MESSAGE);//pour demander entrée
		...
		int dialogResult = JOptionPane.showConfirmDialog(this, "Partie terminée, voulez-vous recommencer ?", "Game over !", dialogButton);
		if(dialogResult == 0) {
		  this.gamePanel.init();
		  go();
		} else {
