	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			if(nbr%2==0 && nbr%3==0 && nbr%5==0) {
				System.out.println("ce nombre est divisible par 2, par 3 et par 5");
			}else {
			if(nbr%2==0 || nbr%3==0 || nbr%5==0) {
					if(nbr%2==0 || nbr%3==0 && nbr%5!=0) {
						if(nbr%2==0 && nbr%3==0 && nbr%5!=0) {
						   System.out.println("Ce nombre et divisible par 2 et par 3");
						}else {
							if(nbr%2==0 && nbr%5!=0) {
								System.out.println("Ce nombre est divisible par 2");
							}else {
								if(nbr%3==0 && nbr%5!=0) {
						...
						if(nbr%2==0 && nbr%5==0) {
							System.out.println("Ce nombre est divisible par 2 et par 5");
						}else {
							if(nbr%3==0 && nbr%5==0) {
								System.out.println("Ce nombre est divisible par 3 et par 5");
						}else {
								System.out.println("Ce nombre est divisible par 5");
							}
					}
				...
				System.out.println("Ce nombre n'est pas un multiple de 2, de 3 et de 5");
				}	
			}
